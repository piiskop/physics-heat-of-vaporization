...
E <- U * I * t
E_per_delta_m <- E / delta_m

vaporization <- data.frame(
  identifier,
  c(rep(m1[1], 5), rep(m2[1], 5), rep(m3[1], 5), rep(m4[1], 5)),
  c(m1[2:number_of_elements_in_mass], m2[2:number_of_elements_in_mass], m3[2:number_of_elements_in_mass], m4[2:number_of_elements_in_mass]),
  delta_m,
  I,
  U,
  t,
